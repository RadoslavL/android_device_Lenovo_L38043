LOCAL_PATH := device/Lenovo/L38043

TARGET_BOARD_PLATFORM := mt6765               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := L38043        # From ro.product.board
...
TARGET_CPU_ABI2 :=
TARGET_CPU_VARIANT := generic #cortex-a53             # Change the value to "generic" if build fails suddenly due to arch error
TARGET_2ND_ARCH := arm
TARGET_2ND_ARCH_VARIANT := armv7-a-neon
TARGET_2ND_CPU_ABI := armeabi-v7a
TARGET_2ND_CPU_ABI2 := armeabi
TARGET_2ND_CPU_VARIANT := generic #cortex-a53         # Change the value to "generic" if build fails suddenly due to arch error
...
TARGET_CPU_VARIANT := generic #cortex-a7              # Change the value to "generic" if build fails suddenly due to arch error
